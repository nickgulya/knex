...
(0, _inherits2.default)(Client_SQLCordova, _sqlite2.default);

(0, _assign3.default)(Client_SQLCordova.prototype, {
    ...
    acquireConnection: function acquireConnection() {
        ...
        return new _bluebird2.default(function (resolve, reject) {
            try {
                (function () {
                    /*jslint browser: true*/
                    var db = window.sqlitePlugin.openDatabase({ name: client.name, key: client.key, location: 'default', androidLockWorkaround: 1 }, function (sucess) {
...
exports.default = Client_SQLCordova;
